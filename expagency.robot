...
Створити тендер
  ...
  Wait Until Page Contains Element  xpath=//a[@href="https://torgi.exp-agency.com.ua/tenders"]  10
  Click Element  xpath=//a[@href="https://torgi.exp-agency.com.ua/tenders"]
  Click Element  xpath=//a[@href="https://torgi.exp-agency.com.ua/tenders/index"]
  Click Element  xpath=//a[contains(@href,"https://torgi.exp-agency.com.ua/buyer/tender/create")]
...
Пошук тендера по ідентифікатору
  ...
  Switch browser  ${username}
  Go To  https://torgi.exp-agency.com.ua
  Click Element  xpath=//a[@href="https://torgi.exp-agency.com.ua/tenders"]
  Click Element  xpath=//a[@href="https://torgi.exp-agency.com.ua/tenders/index"]
...
Подати цінову пропозицію
  ...
  ...  Go To  https://torgi.exp-agency.com.ua/bids/send/${url.split('?')[0].split('/')[-1]}
  ...  ELSE  Go To  https://torgi.exp-agency.com.ua/bids/decline/${url.split('?')[0].split('/')[-1]}
  Go To  ${url}
...
Завантажити документ в ставку
  ...
  expagency.Пошук тендера по ідентифікатору   ${username}  ${tender_uaid}
  ${value}=  expagency.Отримати інформацію із пропозиції  ${username}  ${tender_uaid}  ${EMPTY}
  expagency.Скасувати цінову пропозицію  ${username}  ${tender_uaid}
  Wait Until Element Is Visible   xpath=//input[contains(@name, '[value][amount]')]
