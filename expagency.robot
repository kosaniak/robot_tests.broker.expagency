...
Створити тендер
  ...
  Wait Until Page Contains Element  xpath=//a[@href="http://torgi.exp-agency.com.ua/tenders"]  10
  Click Element  xpath=//a[@href="http://torgi.exp-agency.com.ua/tenders"]
  Click Element  xpath=//a[@href="http://torgi.exp-agency.com.ua/tenders/index"]
  Click Element  xpath=//a[contains(@href,"http://torgi.exp-agency.com.ua/buyer/tender/create")]
...
Пошук тендера по ідентифікатору
  ...
  Switch browser  ${username}
  Go To  http://torgi.exp-agency.com.ua
  Click Element  xpath=//a[@href="http://torgi.exp-agency.com.ua/tenders"]
  Click Element  xpath=//a[@href="http://torgi.exp-agency.com.ua/tenders/index"]
...
Подати цінову пропозицію
  ...
  ...  Go To  http://torgi.exp-agency.com.ua/bids/send/${url.split('?')[0].split('/')[-1]}
  ...  ELSE  Go To  http://torgi.exp-agency.com.ua/bids/decline/${url.split('?')[0].split('/')[-1]}
  Go To  ${url}
